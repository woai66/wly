...
#define UART_TX_PIN             (DEBUG_UART_TX_PIN  )            // 串口1默认 UART3_MAP0_TX_B10
#define UART_RX_PIN             (DEBUG_UART_RX_PIN  )            // 默认 UART3_MAP0_RX_B11
#define UART1_TX_PIN            (UART1_MAP0_TX_A9  )             // 串口2发送引脚
#define UART1_RX_PIN            (UART1_MAP0_RX_A10  )            // 串口2接收引脚
#define UART2_TX_PIN            (UART2_MAP0_TX_A2  )             // 串口3发送引脚
#define UART2_RX_PIN            (UART2_MAP0_RX_A3  )             // 串口3接收引脚-- from zf_driver_uart.h
